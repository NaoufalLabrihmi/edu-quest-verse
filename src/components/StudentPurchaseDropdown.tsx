    ...
    >
      ...
      <div className="flex items-center gap-2 px-4 pt-3 pb-2 border-b border-gray-800">
        {TABS.map(t => (
          <button
            key={t.value}
            className={`px-3 py-1.5 rounded-lg text-sm font-semibold transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-cyan-500/60
              ${tab === t.value ? 'bg-cyan-700/80 text-white shadow' : 'bg-gray-900/60 text-cyan-200 hover:bg-cyan-800/30'}`}
