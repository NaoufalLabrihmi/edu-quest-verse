...
export function Navigation({ isLoggedIn = false, userRole = 'student', userName = '', userPoints = 0 }: NavigationProps) {
          ...
          {isLoggedIn ? (
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-1 px-3 py-1 bg-gradient-to-r from-edu-purple-100 to-edu-blue-100 rounded-full text-sm">
                <span className="text-edu-purple-500 font-semibold">{userPoints}</span>
          ...
          <nav className="flex flex-col space-y-3 py-2">
            ...
            {isLoggedIn ? (
              <>
                ...
                <button className="text-left text-red-500 py-2">
                  Log out
                </button>
              </>
            ) : (
